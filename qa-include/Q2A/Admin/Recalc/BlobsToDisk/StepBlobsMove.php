...
class Q2A_Admin_Recalc_BlobsToDisk_StepBlobsMove extends Q2A_Admin_Recalc_AbstractStep
{
	...
	public function setup()
	{
		...
		$this->totalItems = qa_db_count_blobs_in_db();
	...
	public function execute()
	{
		...
		$blobs = qa_db_get_next_blobs_in_db($this->lastProcessedItemId, self::BATCH_AMOUNT);
