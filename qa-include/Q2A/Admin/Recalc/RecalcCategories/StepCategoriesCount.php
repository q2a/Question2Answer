...
class Q2A_Admin_Recalc_RecalcCategories_StepCategoriesCount extends Q2A_Admin_Recalc_AbstractStep
{
	const BATCH_AMOUNT = 10;

	public function __construct()
	{
		$this->messageLangId = 'admin/recalc_categories_recounting';
	}
	...
	public function execute()
	{
		...
		// For qa_db_ifcategory_qcount_update()
