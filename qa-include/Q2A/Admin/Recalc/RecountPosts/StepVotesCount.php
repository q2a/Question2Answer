...
class Q2A_Admin_Recalc_RecountPosts_StepVotesCount extends Q2A_Admin_Recalc_AbstractStep
{
	const BATCH_AMOUNT = 20000;

	public function __construct()
	{
		$this->messageLangId = 'admin/recount_posts_votes_recounted';
	}
	...
	public function execute()
	{
		...
		if (!empty($postids)) {
			...
			qa_db_posts_votes_recount($this->nextItemId, $lastpostid);
